...
[FAF](https://faf.one) (Foundational AI-context Format) — IANA-registered (`application/vnd.faf+yaml`). Over 110k+ downloads; see [faf.one/downloads](https://faf.one/downloads) for latest stats.
